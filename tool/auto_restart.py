#!/usr/bin/env python
#coding=utf-8
# crontab config: * * * * * root python /opt/zarkpy/tool/auto_restart.py 4
import os
import sys
import traceback
from datetime import datetime
ERROR_LOG = '/opt/zarkpy/log/auto_restart'
PID_FILE  = '/var/run/zarkpy-master-spawn-fcgi.pid'
